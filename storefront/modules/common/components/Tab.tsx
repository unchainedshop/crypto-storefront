    ...
    <div className="py-6">
      <div className="lg:hidden">
        ...
        <select
          ...
          id="selected-tab"
          name="selected-tab"
          className="mt-1 block w-full rounded-md border-slate-300 py-2 pl-3 pr-10 text-base capitalize focus:border-indigo-400 focus:outline-none focus:ring-indigo-400 sm:text-sm"
          value={tab}
        >
          {tabItems.map((value) => (
